...
```text
environment_contract=environment-contract-sha256:64582256f16c6eaa19ba3232ca48fe027142c01877bec780318db0586c6ae07d
...
```toml
environment_fingerprint = "environment-contract-sha256:64582256f16c6eaa19ba3232ca48fe027142c01877bec780318db0586c6ae07d"
```
...
```powershell
python -c "from pathlib import Path; from vsm.environment import EnvironmentContract; from vsm.environment.artifacts import LocalEnvironmentContractStore; c=EnvironmentContract.model_validate({'required_shell':'powershell','required_endpoints':['api.openai.com'],'workspace_writable':True,'minimum_memory_mb':4096,'supported_sandboxes':['workspace-write'],'required_sandbox':'workspace-write','path_mapping_names':['workspace-root'],'minimum_cli_version':'0.144.5'}); a=LocalEnvironmentContractStore(Path(r'D:/userdata/docs/projects/_cutover_20260720_fable_activation/production/environment-artifacts')).save(c,artifact_key='codex-workspace',version=1); print(a.fingerprint)"
```

**期待される出力 / 状態**

`environment-contract-sha256:64582256...6ae07d` が表示され、
...
Select-String -LiteralPath $TransitionConfig -Pattern "active_route_snapshot_id|environment-contract-sha256:64582256|preflight_enabled = true"
```
...
if ($Health.preflight.environment_fingerprint -ne "environment-contract-sha256:64582256f16c6eaa19ba3232ca48fe027142c01877bec780318db0586c6ae07d") { throw "PilotHost contract fingerprintが不一致です" }
```
