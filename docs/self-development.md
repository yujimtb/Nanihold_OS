...
SSE events、control、human-decision、merge-outcome、allow-list artifact、health を提供する。作成時の
...
状態 rail、合議全文、gate / audit / budget、artifact、PR説明文コピー、Human承認、介入、merge outcome
